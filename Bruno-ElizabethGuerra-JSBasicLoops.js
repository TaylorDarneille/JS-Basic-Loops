...
for (i=0; i<=200; i++) {
  ...
  let rand = ['...human...why you taking pictures of me?...', '...the catnip made me do it...', 'meow?', '...why does the red dot always get away...']
  ...
  for (var number in phoneBook) {
    if (phoneBook[number] === "333-333-3333") console.log(number)
  }